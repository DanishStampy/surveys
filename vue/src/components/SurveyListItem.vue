<template>
    <div class="flex flex-col py-4 px-6 shadow-md bg-white hover:bg-gray-50 g-[470px]">
        ...
        <div class="flex justify-between items-center mt-3">
            ...
            <div class="flex items-center">
                ...
                <button v-if="survey.id" type="button" @click="emit('delete', survey)"
                    class="h-8 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-red-500 foucs:ring-2 foucs:ring-offset-2 focus:ring-red-500">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
